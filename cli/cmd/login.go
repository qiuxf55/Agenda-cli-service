...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		res, err := http.PostForm("http://localhost:8080/v1/users/login", url.Values{"name": {name}, "password": {password}})
...
func init() {
	...
	loginCmd.Flags().StringP("name", "n", "Anonymous", "提供用户名字")
	loginCmd.Flags().StringP("password", "p", "Anonymous", "提供用户密码")
